...
user61 = User.create(email: 'FrankGehry@gmail.fr', password: "123456")
artist61 = Artist.new(
  first_name: 'Frank',
  last_name: 'Gehry',
  date_of_birth: '1929-02-02',
...
artist63 = Artist.new(
  ...
  description: "Charles-Édouard Jeanneret-Gris, dit Le Corbusier, est un architecte, urbaniste, décorateur, peintre, sculpteur, auteur suisse naturalisé français",
  category: architecte,
  user: user63
)
artist63.save!
...
user87 = User.create(email: 'IsabelleAuricoste@sfr.fr', password: "123456")
artist87 = Artist.new(
  first_name: 'Isabelle',
  last_name: 'Auricoste',
...
user91 = User.create(email: 'TinTin@yahoo.fr', password: "123456")
artist91 = Artist.new(
  first_name: 'Tin-Tin',
  last_name: 'Tin',
